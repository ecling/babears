...
class Mage_Adminhtml_Block_Catalog_Product_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getRequest()->getParam('popup')) {
            if (!$this->getProduct()->isReadonly()) {
                ...
                $this->setChild('save_one_buton_trans_edit_button',
                    $this->getLayout()->createBlock('adminhtml/widget_button')
                        ->setData(array(
                            'label'     => Mage::helper('catalog')->__('Save and One Button Translate'),
                            'onclick'   => 'saveOneButtonTrans(\''.$this->getSaveOneButtonTrans().'\')',
                            'class' => 'save'
                        ))  
                );  
            }
    ...
    public function getOneButtonTransButtonHtml()
    {
        return $this->getChildHtml('save_one_buton_trans_edit_button');
    }
    ...
    public function getSaveOneButtonTrans()
    {
        return $this->getUrl('*/*/trans', array(
            '_current'   => true,
            'back'       => 'edit',
            'tab'        => '{{tab_id}}',
            'active_tab' => null
